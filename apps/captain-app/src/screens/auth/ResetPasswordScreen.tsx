...
const styles = StyleSheet.create({
  ...
  infoBox: { backgroundColor: '#E3F2FD', borderRadius: 10, padding: 14, marginBottom: 24, borderWidth: 1, borderColor: '#BBDEFB' },
  ...
  successTitle: { fontSize: 22, fontWeight: 'bold', color: '#1565C0', marginBottom: 8 },
