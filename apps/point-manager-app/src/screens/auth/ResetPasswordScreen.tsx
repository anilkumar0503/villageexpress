...
const styles = StyleSheet.create({
  ...
  infoBox: { backgroundColor: '#FFF3E0', borderRadius: 10, padding: 14, marginBottom: 24, borderWidth: 1, borderColor: '#FFE0B2' },
  ...
  successTitle: { fontSize: 22, fontWeight: 'bold', color: '#E65100', marginBottom: 8 },
